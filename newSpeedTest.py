...
#	upload = ((json_object['upload']['bytes']/bitTobyte)/(json_object['upload']['elapsed']/1000))*(json_object['upload']['bandwidth']/bitTobyte)
	...
	colUpload  = oColor['ok'] if upload > 90 else oColor['mh'] if upload > 50 else oColor['ko']
	colDownload= oColor['ok'] if download > 90 else oColor['mh'] if download > 50 else oColor['ko']
